...
export default function MenuPage({
  ...
  return (
    ...
    translate-x-0
    z-60  // 👈 tapa el navbar superior pero no el BottomNav
  "
    >
          ...
          {!showSelector && (
            <div>
              <div className="grid grid-cols-2 gap-2 py-4 w-full">
                ...
                >
                  <RiTeamLine className="w-12 h-12" />

                  <p className="text-lg font-bold">Equipo</p>
                </button>

                <button
                  onClick={() => goTo("/dashboard/finance")}
                  className="flex flex-col items-center justify-center px-2 py-6 bg-luminiBrandBlue hover:bg-gray-700 border border-b border-gray-600 rounded-md w-full h-32"
                >
                ...
                <button
                  onClick={() => goTo("/dashboard/commercial")}
                  className="flex flex-col items-center justify-center px-2 py-6 bg-luminiBrandBlue hover:bg-gray-700 border border-b border-gray-600 rounded-md w-full h-32"
                >
                  <RiBriefcase2Line className="w-12 h-12" />
                  <p className="text-lg font-bold">Comercial</p>
                </button>

                <button
                  onClick={() => goTo("/dashboard/metrics")}
                  className="flex flex-col items-center justify-center px-2 py-6 bg-luminiBrandBlue hover:bg-gray-700 border border-b border-gray-600 rounded-md w-full h-32"
                >
                  <LuChartNoAxesCombined className="w-12 h-12" />
                  <p className="text-lg font-bold">Métricas</p>
                </button>
              </div>
            </div>
          )}
