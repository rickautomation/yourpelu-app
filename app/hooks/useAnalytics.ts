...
export type PaymentMethodReport = { method: string; count: number; totalPrice: number };
export type TopCategoryReport = { category: string; type: string; count: number };
export type CategorySummary = { categoryId: string; categoryName: string; typeId: string; typeName: string; count: number };
